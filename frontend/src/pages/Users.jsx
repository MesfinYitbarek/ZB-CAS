    ...
    <div className="p-7 h-[calc(100vh-3rem)] flex flex-col">
      ...
      <div className="flex justify-between items-start mb-3 flex-shrink-0">
        ...
        <div className="flex items-center gap-2 flex-shrink-0">
          <button
            onClick={openImport}
            className="flex items-center gap-1.5 px-2 py-1 border border-gray-300 bg-white text-brand-black rounded-lg font-semibold text-sm hover:bg-gray-50 transition-colors"
          >
      ...
      <Modal open={showImport} onClose={() => { if (!importing) setShowImport(false); }} title="Import Users" large>
        {!importResult ? (
          <div className="space-y-5">
            <div className="flex items-start gap-3 bg-gray-100 border border-gray-300 text-gray-700 rounded-lg p-4">
    ...
    <div className="space-y-5">
      ...
      <div className="grid grid-cols-3 gap-3">
        ...
        <div className="bg-gray-100 border border-gray-300 rounded-lg p-4 text-center">
          <p className="text-2xl  font-bold text-gray-700">{summary.imported}</p>
      ...
      {imported.length > 0 && (
        <div className="border border-gray-200 rounded-lg overflow-hidden">
          <div className="bg-gray-50 px-4 py-2 flex items-center gap-2 text-sm font-semibold text-gray-700">
            <CheckCircle2 className="w-4 h-4 text-gray-700" /> Imported Users (temporary passwords)
          </div>
