      ...
      <div className="flex items-center justify-center min-h-screen px-4 py-8">
        ...
        <div className="relative bg-white rounded-2xl shadow-2xl w-full max-w-4xl">
          ...
          <div className="p-6 max-h-[80vh] overflow-y-auto space-y-5">
            ...
            {/* Questions */}
            <QuestionDetailsSection questionDetails={questionDetails} summary={questionSummary} loading={loadingQuestions} />
            {/* Security */}
...
const Paginator = ({ pagination, goToPage }) => {
  ...
  return (
    <div className="flex flex-col sm:flex-row justify-between items-center gap-3 mt-5 pt-5 border-t border-gray-100">
    ...
    <div className="p-7">
      ...
      {isAdmin && stats && (
        <div className="grid grid-cols-2 md:grid-cols-4 gap-4 mb-6">
          ...
          {Object.entries(stats.levelDist).map(([level, count]) => null)}
      ...
      {loading ? (
        ...
        <div className="bg-white rounded-xl shadow-card border border-gray-100 p-16 text-center">
          ...
          <p className="text-gray-400 text-sm max-w-sm mx-auto">{activeFilterCount > 0 ? 'Try adjusting your filters to see more results.' : 'No assessment results are available yet.'}</p>
